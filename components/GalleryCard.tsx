...
export default function GalleryCard() {
  return (
    <section className="pt-28 px-4 sm:px-6 lg:px-10 w-full">
      <p className="text-center text-2xl md:text-3xl text-gray-400 mb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {images.map((src, index) => (
          <div
            key={index}
            className="relative h-60 overflow-hidden rounded-2xl shadow-md group"
          >
            <Image
              src={src}
              alt={`Gallery ${index + 1}`}
