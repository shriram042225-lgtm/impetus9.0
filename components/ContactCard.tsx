      ...
      <div className="p-3 bg-zinc-950">
        ...
        <div className="flex items-center justify-between mt-4">
          <div className="flex gap-3">
            {person.insta && (
              <a href={person.insta} className="text-zinc-600 hover:text-white transition-colors">
                <Instagram size={14} strokeWidth={1.5} />
              </a>
            )}
            {person.link && (
              <a href={person.link} className="text-zinc-600 hover:text-white transition-colors">
                <Linkedin size={14} strokeWidth={1.5} />
              </a>
            )}
          </div>
          <a href={`tel:${person.phone}`} className="text-zinc-600 hover:text-white transition-colors">
